...
class RapportIdentif extends StatefulWidget {
  @override
  _RapportIdentifState createState() => _RapportIdentifState();
}

class _RapportIdentifState extends State<RapportIdentif> {
  List list = <dynamic>[];
            ...
            ElevatedButton(
              onPressed: () async {
                setState(() async {
                  ...
                  final file = File('${dir.path}/identificateurs.pdf');
