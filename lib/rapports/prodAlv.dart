...
class RapportProdAlv extends StatefulWidget {
  @override
  _RapportProdAlvState createState() => _RapportProdAlvState();
}

class _RapportProdAlvState extends State<RapportProdAlv> {
  List list = <dynamic>[];
            ...
            ElevatedButton(
              onPressed: () async {
                setState(() async {
                  ...
                  final file = File('${dir.path}/prod_alevin.pdf');
