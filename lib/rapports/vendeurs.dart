...
class RapportVendeur extends StatefulWidget {
  @override
  _RapportVendeurState createState() => _RapportVendeurState();
}

class _RapportVendeurState extends State<RapportVendeur> {
  List list = <dynamic>[];
  ...
  Widget build(BuildContext context) {
    ...
    final data = list.map((item) {
      return [
        '${item['idVendeur']}',
        '${item['nomVendeur']} - ${item['postnomVendeur']}',
        '${item['ageVendeur']}',
        '${item['telephoneVendeur']}',
        '${item['adresseVendeur']}',
        '${item['sexeVendeur']}',
      ];
    }).toList();
