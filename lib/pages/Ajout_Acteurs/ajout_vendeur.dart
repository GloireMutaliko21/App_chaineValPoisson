...
class AjoutVendeur extends StatefulWidget {
  const AjoutVendeur({Key key}) : super(key: key);

  @override
  _AjoutVendeurState createState() => _AjoutVendeurState();
}
...
Future<bool> initData() async {
  await DataInsert.getInstance.addSeller(data: {
    "nomVendeur": nom.text,
    "postnomVendeur": postnom.text,
    "sexeVendeur": sexe.toString().substring(0, 1),
    "ageVendeur": age.text,
    "telephoneVendeur": num.text,
    "adresseVendeur": adresse.text,
