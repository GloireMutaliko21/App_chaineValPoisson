        ...
        children: [
          ...
          DataTable2(
              ...
              rows: List<DataRow>.generate(widget.data.length, (index) {
                ...
                nom.text = data['nomVendeur'];
                postnom.text = data['postnomVendeur'];
                age.text = data['ageVendeur'];
                tel.text = data['telephoneVendeur'];
                adresse.text = data['adresseVendeur'];
